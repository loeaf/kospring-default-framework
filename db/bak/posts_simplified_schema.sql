-- 순환발주 기반 광고 소개 블로그 시스템 DDL (간소화 버전)
...
-- 라운드 완성도 체크 뷰 (n명 참여시 n-1개 게시글 작성 여부)
...
-- 라운드 1 (2024-01-01 ~ 2024-01-31)의 게시글들
('AI 마케팅 혁신 - 스마트애드 솔루션', '
...
-- 현재 활성 중인 게시글 조회
-- SELECT title, author_name, target_ad_content, assigned_cost
-- FROM active_posts
